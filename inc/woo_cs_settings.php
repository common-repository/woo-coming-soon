...
<?php 
	...
	$product_page_hooks = array(
	        ...
	        'woocommerce_before_add_to_cart_form' => array('disabled'),
                ...
                <?php
                    ...
                    if(!empty($product_page_hooks)){
                        ...
                        foreach($product_page_hooks as $hook_key => $hook){
							...
							$hook = is_array($hook)?$hook:array($hook);
							
							$disabled = (in_array('disabled', $hook) ? 'disabled' : '');

                            echo "<option value='$hook_key' $selected $disabled>$hook_key</option>";
                        }
